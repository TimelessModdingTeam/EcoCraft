...
public class SmelteryBlock extends TableBlock implements IRegisterContent {
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.setBlockState(
					pos,
					SmelteryBlock.lit.getBlock().getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)),
					3);
			...
			worldIn.setBlockState(
					pos,
					SmelteryBlock.unlit.getBlock().getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)),
					3);
			// worldIn.setBlockState(pos,
	...
	public void register() {
		SmelteryBlock.unlit = EcoRegistry.instance.getObjReg("smeltery");
		SmelteryBlock.lit = EcoRegistry.instance.getObjReg("smeltery_lit");
	}
