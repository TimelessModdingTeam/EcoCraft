package net.ecocraft.ecoearth.client.gui;

import net.ecocraft.ecoearth.EcoEarth;
import net.ecocraft.ecoearth.google.geocode.ReverseGeoCode;
import net.ecocraft.ecoearth.google.streetview.StreetView;
...
public class GuiStreetView extends GuiScreen {
    ...
    public GuiStreetView(final EntityPlayer player) {
        latitude = EcoEarth.generator.toLat(player.posZ);
        longitude = EcoEarth.generator.toLong(player.posX);
