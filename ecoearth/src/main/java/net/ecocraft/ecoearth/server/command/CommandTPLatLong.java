package net.ecocraft.ecoearth.server.command;
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length >= 2) {
            try {
                ...
                double x = EcoEarth.generator.fromLong(longitude);
                double z = EcoEarth.generator.fromLat(latitude);
                int y = EcoEarth.generator.getHeightForCoords((int) x, (int) z) + 1;
