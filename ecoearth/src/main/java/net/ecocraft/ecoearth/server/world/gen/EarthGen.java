...
public class EarthGen {
    ...
    private static final String HEIGHTMAP_LOCATION = "/assets/ecoearth/data/earth_heightmap.mchmap";
    private static final String BIOMEMAP_LOCATION = "/assets/ecoearth/data/earth_biomemap.mcbmap";
