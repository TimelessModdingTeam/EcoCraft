...
public class WorldChunkManagerEarth extends WorldChunkManager {
    /**
     * The biome list.
     */
    ...
    protected WorldChunkManagerEarth(EarthGen generator) {
    ...
    public WorldChunkManagerEarth(long seed, WorldType worldType, String p_i45744_4_, EarthGen generator) {
        this(generator);
        this.field_180301_f = p_i45744_4_;
        this.seed = seed;
    }

    public WorldChunkManagerEarth(World worldIn, EarthGen generator) {
