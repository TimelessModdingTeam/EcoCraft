...
public class ContentObject {
    ...
    //Constructors
    public ContentObject(Block block, String unlocalizedName, CreativeTabs creativeTab,
    ...
    public ContentObject(Block block, String unlocalizedName, CreativeTabs creativeTab,
                         float hardness, float resistance, Block.SoundType sound, String harvestString, int harvestLevel) {
    ...
    public ContentObject setTileEntity(Class<? extends TileEntity> tileEntityClass, String name, TileEntitySpecialRenderer renderer) {
        this.tileEntityClass = tileEntityClass;
        this.tileEntityName = name;
